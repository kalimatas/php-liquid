...
class TagContinueTest extends TestCase
{
	...
	{
		$this->assertTemplateResult('    ', '{%for item in array%} {%continue%} yo {%endfor%}', ['array' => [1, 2, 3, 4]]);
		$this->assertTemplateResult(' yo  yo  yo  yo ', '{%for item in array%} yo {%continue%} {%endfor%}', ['array' => [1, 2, 3, 4]]);
		$this->assertTemplateResult('  1   2     4 ', '{%for item in array%} {%if item == 3%} {%continue%} {%endif%} {{ item }} {%endfor%}', ['array' => [1, 2, 3, 4]]);
	}
